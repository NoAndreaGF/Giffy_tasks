...
import equipo1.giffytasks.databinding.ActivityQuizGiftBinding
import java.io.File

class quiz_gift : AppCompatActivity() {
    private lateinit var binding: ActivityQuizGiftBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityQuizGiftBinding.inflate(layoutInflater)
